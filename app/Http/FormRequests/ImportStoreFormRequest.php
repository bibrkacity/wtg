...
class ImportStoreFormRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'offers.*' => 'array:external_id,property,check_in,check_out,max_guests,price,currency,available_units,expires_at',
